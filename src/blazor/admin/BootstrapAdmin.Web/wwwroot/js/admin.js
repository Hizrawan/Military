        ...
        login: function (form, obj, url, method) {
            ...
            $('.btn-login').on('click', function (e) {
                ...
                if (mobile) {
                    ...
                    var $verifyCode = $form.find('[name="verifyCode"]');
                    var $verifyCodeAnswer = $form.find('[name="verifyCodeAnswer"]');
                    userName = $userName.val();
                    password = $password.val();
                    verifyCode = $verifyCode.val();
                    verifyCodeAnswer = $verifyCodeAnswer.val();
                ...
                var postData = JSON.stringify({ userName, password, verifyCode, verifyCodeAnswer });
