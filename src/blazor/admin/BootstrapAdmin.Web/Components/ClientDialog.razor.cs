...
public partial class ClientDialog
{
    [Inject]
    [NotNull]
    private IStringLocalizer<ClientDialog>? Localizer { get; set; }

    [Inject]
    [NotNull]
    private IStringLocalizer<AppIdValidator>? LocalizerAppId { get; set; }
    ...
    protected override void OnInitialized()
    {
        ...
        if (Value.AppId == null)
        {
            Validators.Add(new AppIdValidator(DictService, LocalizerAppId));
        }
    }
